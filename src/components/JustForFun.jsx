...
const JustForFunCard = ({index, testimonial, name, title, designation, company, source_code_link}) => {
  return (
    ...
    <div className="mt-12 bg-black-100 rounded-[20px]">
      ...
      bg-tertiary rounded-2xl min-h-[300px]`}>
        <motion.div variants={textVariant()}>
          <p className={styles.sectionSubText}>Discover the fun and creative projects I developed in my spare time, born from moments of boredom and bursts of inspiration.</p>
